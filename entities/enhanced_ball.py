...
from utils.constants import FRICTION, WHITE, BLUE, RED

class EnhancedBall(Ball):
    def __init__(self, x, y, radius=15, color=BLUE):
        super().__init__(x, y, radius, color)  # Pass color to Ball constructor
        self.trail_color = color  # Use the provided color for trail
        self.glow_color = (70, 130, 230, 120)
    ...
    def apply_force(self, force_x, force_y):
        ...
        # Particle effect generation removed to avoid duplication with game.py
